...
import com.tang.util.device.ShellUtils;
import com.tang.util.function.IntentUtils;
import com.tang.util.function.ProcessUtils;
import com.tang.util.security.hash.SHAUtils;
...
public class AppUtils {
    ...
    public static class AppInfo {
        ...
        public AppInfo(String packageName, String name, Drawable icon, String packagePath,
                       String versionName, int versionCode, int uid, boolean isSystem) {
            this.setName(name);
            this.setIcon(icon);
    ...
    private static AppInfo getBean(PackageManager pm, PackageInfo pi) {
        ...
        return new AppInfo(packageName, name, icon, packagePath, versionName, versionCode, uid, isSystem);
    }
    ...
    public static String getAppStringMetaData(Context context, String key) {
        Bundle bundle = getAppMetaDataBundle(context);
        if (bundle != null) {
     ...
     * @return boolean
     */
    public static boolean getAppBooleanMetaData(Context context, String key) {
        Bundle bundle = getAppMetaDataBundle(context);
        if (bundle != null) {
