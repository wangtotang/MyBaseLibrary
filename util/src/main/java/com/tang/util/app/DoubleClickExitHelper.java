...
public class DoubleClickExitHelper {
	 ...
	 */
	public DoubleClickExitHelper(Context context, String hintMessage, int effectiveIntervalTime) {
	 ...
	 */
	public DoubleClickExitHelper(Context context, String hintContent) {
